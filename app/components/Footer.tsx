                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center pb-12 border-b border-gray-800/60 gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="relative group flex items-center justify-center">
                                ...
                                <div className="absolute bottom-full mb-2 hidden group-hover:block bg-[#b88e2f] text-white text-[11px] font-bold font-sans px-2.5 py-1.5 rounded shadow-lg whitespace-nowrap z-50 pointer-events-none transition-opacity duration-300">
                                    Start a Chat: +91 7479997369
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 border-4 border-transparent border-t-[#b88e2f]"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-4 text-sm font-sans text-gray-400 font-light">
                                <div className="flex items-start gap-4">
                                    ...
                                    <span className="mt-1">+1 (213) 465 789</span>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-8 h-8 rounded-full bg-white/10 text-white flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg className="w-4 h-4 stroke-current" fill="none" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="mt-1">info@domain.com</span>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-8 h-8 rounded-full bg-white/10 text-white flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg className="w-4 h-4 stroke-current" fill="none" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="mt-1">Generata Zietka Jerzego 54, Myslowice 41-412</span>
                                </div>
                            </div>
                        </div>
